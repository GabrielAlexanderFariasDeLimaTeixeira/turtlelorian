...
class ATSTurtle(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [pygame.image.load('images/ATS_one.png').convert_alpha(),
                        pygame.image.load('images/ATS_two.png').convert_alpha(),
                        pygame.image.load('images/ATS_three.png').convert_alpha()]
        self.speed = SPEED
        self.current_image = 0
        self.image = pygame.image.load('images/ATS_one.png').convert_alpha()
...
class CargoTurtle(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [pygame.image.load('images/CT_one.png').convert_alpha(),
                        pygame.image.load('images/CT_two.png').convert_alpha(),
                        pygame.image.load('images/CT_three.png').convert_alpha()]
        self.speed = SPEED*2
        self.current_image = 0
        self.image = pygame.image.load('images/CT_one.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
...
class THunter(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [pygame.image.load('images/TH_one.png').convert_alpha(),
                        pygame.image.load('images/TH_two.png').convert_alpha(),
                        pygame.image.load('images/TH_three.png').convert_alpha()]
        self.speed = SPEED*4
        self.current_image = 0
        self.image = pygame.image.load('images/TH_one.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
...
class Turtlelorian(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [pygame.image.load('images/ttl_up.png').convert_alpha(),
                        pygame.image.load('images/ttl_mid.png').convert_alpha(),
                        pygame.image.load('images/ttl_down.png').convert_alpha()]
        self.speed = SPEED
        self.current_image = 0
        self.image = pygame.image.load('images/ttl_up.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
